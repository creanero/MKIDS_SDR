...
class AppForm(QMainWindow):
	...
	phaseraw = []
	    ...
	    Iraw0.append(struct.unpack('>l', bin_data_I[m:m+4])[0])
	    ...
	    Iraw4.append(struct.unpack('>l', bin_data_I[2*m:2*m+4])[0])
	    Iraw5.append(struct.unpack('>l', bin_data_I[2*m+1:2*m+5])[0])
	    Iraw6.append(struct.unpack('>l', bin_data_I[2*m+2:2*m+6])[0])
	    Iraw7.append(struct.unpack('>l', bin_data_I[2*m+3:2*m+7])[0])
	    
	    Iraw8.append(struct.unpack('>l', bin_data_I[3*m:3*m+4])[0])
	    Iraw9.append(struct.unpack('>l', bin_data_I[3*m+1:3*m+5])[0])
	    Iraw10.append(struct.unpack('>l', bin_data_I[3*m+2:3*m+6])[0])
	    Iraw11.append(struct.unpack('>l', bin_data_I[3*m+3:3*m+7])[0])
	    
	    Iraw12.append(struct.unpack('>l', bin_data_I[4*m:4*m+4])[0])
