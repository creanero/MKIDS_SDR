...
def animate(q):
	...
	print'len(phase_cpu) = ', len(phase_cpu)	

	phase_cpu_max_index = np.argmax(phase_cpu)

	print'phase_cpu_max_index = ', phase_cpu_max_index		

	if phase_cpu_max_index < 200: 
		phase_cpu_max_index = 200
		colour = 'green'	

	if phase_cpu_max_index > len(phase_cpu) - 1001: 
		phase_cpu_max_index = len(phase_cpu) - 1001	
		colour = 'orange'
	...
	ax2.plot(phaseplot, '.', color=colour)
