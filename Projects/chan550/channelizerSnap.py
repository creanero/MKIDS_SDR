...
class AppForm(QMainWindow):
	...
	self.axes1.set_xlabel('Time [us]')
        self.axes1.set_ylabel('Phase [Degress]')
    ...
    def readPulses(self):
        ...
        ch = int(self.textbox_channel.text())
        numpy.savetxt('/opt/software/colin1/test88.dat', p1[ch])
    ...
    def create_main_frame(self):
        ...
        self.textbox_coeffsFile = QLineEdit('/opt/software/colin1/LUT/matched_30us.txt')
